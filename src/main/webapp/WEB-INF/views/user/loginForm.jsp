...
<div class="container">
	<form action="/auth/loginProc " method="post">
		...
		<a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=fca832f52f3590f2cf2832c659cf050d&redirect_uri=http://localhost:8000/auth/kakao/callback">
